...
const EMAILS = [
  { id: 'e1', unread: true, important: true, from: 'Hetal — Billing', subject: 'UB-04 analysis ready', preview: 'Numbers are in for the transition model — needs your sign-off before the Wed meeting.', time: 'Last night · 23:14', body: "Hi Dr. Romano — I've finished the UB-04 transition model. Sign-off before Wednesday's meeting?" },
  { id: 'e2', unread: true, important: true, from: 'Research lab', subject: 'Positive reply — wearable pilot', preview: 'They are interested and want to schedule a call next week.', time: 'Today · 07:55', body: 'We would like to move ahead with a scoping call next week.' },
  { id: 'e3', unread: true, important: false, from: 'Billing system support', subject: 'Coding question — follow-up', preview: 'Following up on the place-of-service coding question.', time: 'Today · 09:10', body: 'Routed to the billing configuration team; expect a reply within two business days.' },
  { id: 'e4', unread: false, important: false, from: 'Commercial payer relations', subject: 'Provider notice — network update', preview: 'Routine network bulletin. No action required.', time: 'Yesterday · 16:20', body: 'Routine provider network bulletin. No action required at this time.' },
  { id: 'e5', unread: false, important: true, from: 'Front desk lead', subject: 'N1 conversion SOP — draft 2', preview: 'Second draft of the rollout plan for the MAs.', time: 'Yesterday · 14:02', body: 'Draft 2 of the N1 conversion SOP for the medical assistants is attached.' },
  { id: 'e6', unread: true, important: true, from: 'Practice manager', subject: 'Monday provider report — ready', preview: "This week's provider spreadsheet is finalized and shared.", time: 'Today · 06:48', body: 'The weekly provider report is done and in the shared folder.' },
  { id: 'e7', unread: true, important: false, from: 'Regenerative supplier', subject: 'Reorder confirmation', preview: 'Your peptide protocol reorder ships Thursday.', time: 'Today · 08:20', body: 'This confirms your regenerative protocol reorder; ships Thursday.' },
  { id: 'e8', unread: true, important: false, from: 'IT support', subject: 'Mailbox storage notice', preview: 'Routine — mailbox at 70% of quota.', time: 'Yesterday · 18:05', body: 'Your mailbox has reached 70% of its storage quota. No action required yet.' },
];
